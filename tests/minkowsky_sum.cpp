...
TEST(MINKOWSKY, sample3)
{
    using cg::point_2;
    std::vector<point_2> pts1 = boost::assign::list_of(point_2(-10, -10))
                                                     (point_2(10, -10))
                                                     (point_2(10, 10))
                                                     (point_2(-10, 10));

    std::vector<point_2> pts2 = boost::assign::list_of(point_2(-10, -10))
                                                      (point_2(10, -10))
                                                      (point_2(10, 10))
                                                      (point_2(-10, 10));

    std::vector<point_2> pts3 = boost::assign::list_of(point_2(-20, -20))
                                                      (point_2(20, -20))
                                                      (point_2(20, 20))
                                                      (point_2(-20,  20));
